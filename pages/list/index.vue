          ...
          <tr class="w-full">
            <th>
              <select v-model="region" id="countries"
                class="bg-gray-50 text-left py-2.5 border pr-6 border-gray-300 text-gray-400 text-sm rounded-lg block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white focus:outline-none">
              ...
              <form class="flex items-center">
                ...
                <div class="relative w-full">
                  ...
                  <input v-model="search" type="text" id="simple-search"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:outline-none block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                    placeholder="Search" />
                </div>
              </form>
            </th>
