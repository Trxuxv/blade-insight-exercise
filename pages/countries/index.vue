    ...
    <div class="w-5/6 mx-auto h-16 py-3 px-10">
      <form class="flex items-center w-3/6">
        <select
          v-model="region"
          id="countries"
          class="mr-3 bg-gray-50 text-left py-2.5 border pr-6 border-gray-300 text-gray-400 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        >
