        ...
        <div v-show="!loading" class="w-5/6 bg-white h-4/6 mx-auto rounded-lg mt-8 overflow-hidden">
            ...
            <div class="w-2/6 float-right h-full bg-gray-600 rounded-r-lg px-8">
                ...
                <div class="w-full bg-gray-400 h-28 mt-10 rounded-lg grid grid-cols-4">
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Region:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.region }}</div>
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Subregion:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.subregion }}</div>
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Population:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.population }}</div>
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Area:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.area }}</div>
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Demonym:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.demonym }}</div>
                    <div class="text-sm text-center flex justify-center font-semibold items-center">Independent:</div>
                    <div class="text-sm text-center flex justify-center items-center">{{ country?.independent ? 'Yes' :
                            'No'
                    }}</div>
                </div>
                ...
                <div v-show="country?.borders"
                    ...
                    <div class="h-8 flex items-center cursor-pointer text-gray-100 font-bold justify-center text-sm rounded-full text-center bg-yellow-600 "
